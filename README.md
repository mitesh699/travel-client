...
├── .gitignore          # Specifies intentionally untracked files (includes .env, tests/)
...
5.  **Environment Variables (`.env` File):**
    ...
    * **Edit `.env`:** Open the `.env` file and add your secret keys. It should follow this format:
        ...
        # Do NOT commit this file to version control (ensure it's in .gitignore)
    ...
    * **Security:** Ensure `.env` is listed in your `.gitignore` file to prevent committing secrets.
